              ...
              <View style={s.section}>
                ...
                <View style={[s.infoBox, { borderColor: colors.border }]}>
                  ...
                  {payment.cardNumber && (
                    ...
                    >
                      <View style={s.cardLabelRow}>
                        ...
                        />
                        <Text
                          style={[s.cardLabel, { color: colors.textSecondary }]}
                        >
                          شماره کارت پرداخت‌کننده
                        </Text>
                        {payment.cardBank && (
                          <Text
                            style={[s.cardBankText, { color: colors.primary }]}
                          >
                            ({payment.cardBank})
                          </Text>
                        )}
                      ...
                      <Text
                        style={[s.cardValue, { color: colors.textMain }]}
                        selectable
                      >
                        {payment.cardNumber}
                      </Text>
                  ...
                  <View style={s.infoRow}>
                    ...
                    <Text
                      style={[s.infoValue, { color: colors.textMain }]}
                      selectable
                    >

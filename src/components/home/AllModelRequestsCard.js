  ...
  return (
    ...
    >
      ...
      <View style={s.content}>
        <Text style={[s.title, { color: colors.textMain }]} numberOfLines={2}>{request.title}</Text>
...
const s = StyleSheet.create({
  card: {
    borderRadius: 20, borderWidth: 1, overflow: 'hidden', marginBottom: 14,
  ...
  urgentBadge: {
    ...
    backgroundColor: 'rgba(255,152,0,0.95)', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10,
  },
  urgentText: { color: '#fff', fontSize: 10, fontFamily: 'Vazir-Bold' },
  content: { padding: 16, gap: 10 },
  title: { fontSize: 16, fontFamily: 'Vazir-Bold', lineHeight: 23 },
  businessRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  businessName: { fontSize: 12, fontFamily: 'Vazir-Medium', flex: 1 },
  metaRow: { flexDirection: 'row', gap: 8, marginTop: 4 },
  metaItem: {
    flex: 1, flexDirection: 'row', alignItems: 'center', gap: 5,
    paddingHorizontal: 10, paddingVertical: 7, borderRadius: 10,
  },
  metaText: { fontSize: 11, fontFamily: 'Vazir', flex: 1 },
  detailsBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    paddingVertical: 13, paddingHorizontal: 16, borderRadius: 14, marginTop: 6,
    shadowColor: '#E91E63', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4,
  },
  detailsBtnText: { color: '#fff', fontSize: 14, fontFamily: 'Vazir-Bold', flex: 1, textAlign: 'center' },
});
    ...
    >
      <View style={s.imageContainer}>
        ...
        <View style={[s.serviceBadge, { backgroundColor: ad.serviceTypeColor || '#607D8B' }]}>
          ...
          <Text style={s.serviceBadgeText} numberOfLines={1}>{ad.serviceTypeName}</Text>
        </View>
      </View>

      <View style={s.content}>
        <Text style={[s.title, { color: colors.textMain }]} numberOfLines={2}>{ad.title}</Text>
...
const s = StyleSheet.create({
  ...
  serviceBadgeText: { color: '#fff', fontSize: 10, fontFamily: 'Vazir-Bold' },
  ...
  detailsBtn: {
    ...
    shadowColor: '#667eea', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4,
  },
